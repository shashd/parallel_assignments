...
void summary(double elapsed, char primes[]){
    std::cout << "Primes: ";
...
int main(int argc, char *argv[]) {
    ...
    if (rank == 0){
        ...
        char* primes = new char[maximum + 1];
        // reduces data
        MPI_Reduce(sieve, primes, maximum + 1, MPI_BYTE, MPI_BAND, 0, MPI_COMM_WORLD);
        ...
        // reduce data
        MPI_Reduce(sieve, NULL, maximum + 1, MPI_BYTE, MPI_BAND, 0, MPI_COMM_WORLD);
    }
    delete[] sieve;
    MPI_Finalize();
    return 0;
